...
var Bootcamp = /*#__PURE__*/function () {
  ...
  _createClass(Bootcamp, null, [{
    ...
    value: function register(input) {
      ...
      _fs["default"].readFile(path, function (error, data) {
        if (error) {
          console.log(error);
        }

        var existingData = JSON.parse(data);
        var karyawan = new _karyawan["default"](name, password, role);
        existingData.push(karyawan);

        _fs["default"].writeFile(path, JSON.stringify(existingData), function (error) {
          if (error) {
            console.log(error);
          } else {
    ...
    value: function login(input) {
      ...
      _promises["default"].readFile(path).then(function (data) {
        ...
        var idxEmployee = employees.findIndex(function (emp) {
        ...
        if (idxEmployee == -1) {
          ...
          var employee = employees[idxEmployee];
...
_defineProperty(Bootcamp, "addSiswa", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(input) {
    var _input$split5, _input$split6, name, trainer_name, student, dataRead, employees, idxAdmin, idxTrainer, trainerPointed;

    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _input$split5 = input.split(","), _input$split6 = _slicedToArray(_input$split5, 2), name = _input$split6[0], trainer_name = _input$split6[1];
            student = {
              name: name
            };
            _context.next = 4;
          ...
          case 4:
            ...
            employees = JSON.parse(dataRead);
            idxAdmin = employees.findIndex(function (emp) {
          ...
          case 11:
            idxTrainer = employees.findIndex(function (emp) {
              return emp._name == trainer_name;
            });
            trainerPointed = employees[idxTrainer];
